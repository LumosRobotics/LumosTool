...
std::string Prompt(const std::string& question, const std::vector<std::string>& options, int default_index = 0) {
...
int InitProject() {
    ...
    if (yaml_exists) {
        ...
        try {
            ...
            std::cout << "  3. Flash with 'st-flash write build/firmware.bin 0x8000000'" << std::endl;
            std::cout << std::endl;
